...
pub trait DexStableApi<BlockHash, CurrencyId, Balance, AccountId, PoolId> {
    ...
    #[method(name = "dexStable_calculateSwap")]
    fn calculate_swap(
        &self,
        pool_id: PoolId,
        in_index: u32,
    ...
    #[method(name = "dexStable_calculateRemoveLiquidity")]
    ...
    #[method(name = "dexStable_calculateRemoveLiquidityOneCurrency")]
...
pub struct DexStable<C, M> {
    client: Arc<C>,
    _marker: std::marker::PhantomData<M>,
}

impl<C, M> DexStable<C, M> {
...
impl<C, Block, CurrencyId, Balance, AccountId, PoolId>
    DexStableApiServer<<Block as BlockT>::Hash, CurrencyId, Balance, AccountId, PoolId> for DexStable<C, Block>
where
    Block: BlockT,
    ...
    C::Api: DexStableRuntimeApi<Block, CurrencyId, Balance, AccountId, PoolId>,
{
