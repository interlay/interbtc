...
pub mod v0 {
    ...
    pub(crate) type PairStatuses<T: Config> = StorageMap<
        ...
        PairStatus<AssetBalance, <T as frame_system::Config>::BlockNumber, <T as frame_system::Config>::AccountId>,
        ValueQuery,
    >;
}
...
pub mod v1 {
    ...
    impl<T: Config> OnRuntimeUpgrade for MigrateToV1<T> {
        ...
        fn on_runtime_upgrade() -> Weight {
            ...
            weight.saturating_accrue(T::DbWeight::get().reads(pair_statuses_storage_map_v0.len() as u64));
        ...
        fn post_upgrade(state: Vec<u8>) -> Result<(), &'static str> {
            let old_entries: u32 = Decode::decode(&mut &state[..]).expect("pre_upgrade provides a valid state; qed");
    ...
    fn migration_v0_to_v1_works() {
        new_test_ext().execute_with(|| {
            ...
            v0::PairStatuses::<Test>::insert(
                pair,
                v0::PairStatus::Trading(v0::PairMetadata {
                    pair_account: 1,
                    total_supply: 100,
                }),
            );
