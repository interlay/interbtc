...
fn test_check_and_do_reorg() {
    ...
    run_test(|| {
        ...
        ChainsIndex::insert(0, BlockChain {
            chain_id: 0,
        ...
        ChainsIndex::insert(2, BlockChain {
            chain_id: 2,
        ...
        ChainsIndex::insert(4, BlockChain {
            chain_id: 4,
        ...
        ChainsIndex::insert(6, BlockChain {
            chain_id: 6,
        ...
        ChainsIndex::insert(7, BlockChain {
            chain_id: 7,
