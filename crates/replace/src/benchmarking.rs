...
benchmarks! {
    ...
    request_replace {
        ...
        vault.wallet = Wallet::new(BtcPayload::P2SH(H160([0; 20])));
    ...
    auction_replace {
        ...
        old_vault.wallet = Wallet::new(BtcPayload::P2SH(H160([0; 20])));
        ...
        new_vault.wallet = Wallet::new(BtcPayload::P2SH(H160([0; 20])));
        VaultRegistry::<T>::_insert_vault(
            &new_vault_id,
            new_vault
        );
    ...
    execute_replace {
        ...
        let address = BtcPayload::P2SH(H160([0; 20]));
        let mut height = 0;
