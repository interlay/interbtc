...
benchmarks! {
    ...
    }: _(RawOrigin::Signed(vault_id.account_id.clone()), vault_id.clone(), amount)
    ...
    }: _(RawOrigin::Signed(vault_id.account_id.clone()), vault_id.clone(), amount.amount())
    ...
    }: _(RawOrigin::Signed(new_vault_id.account_id.clone()), new_vault_id.clone(), old_vault_id, amount.amount(), griefing, new_vault_btc_address)
