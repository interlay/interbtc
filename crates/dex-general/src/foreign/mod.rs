...
impl<T: Config> Pallet<T> {
    ...
    pub(crate) fn foreign_mint(id: T::AssetId, owner: &T::AccountId, amount: AssetBalance) -> DispatchResult {
    ...
    pub(crate) fn foreign_burn(id: T::AssetId, owner: &T::AccountId, amount: AssetBalance) -> DispatchResult {
