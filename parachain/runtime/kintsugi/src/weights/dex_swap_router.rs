...
impl<T: frame_system::Config> dex_swap_router::WeightInfo for WeightInfo<T> {
	...
	fn swap_exact_tokens_for_tokens_general(a: u32, ) -> Weight {
		...
		Weight::from_parts(43_421_926, 15601)
			// Standard Error: 512_448
			.saturating_add(Weight::from_parts(60_438_145, 0).saturating_mul(a.into()))
	...
	fn swap_exact_tokens_for_tokens_stable(c: u32, ) -> Weight {
		...
		//  Estimated: `16757 + c * (9459 ±45)`
		// Minimum execution time: 113_213_000 picoseconds.
		Weight::from_parts(114_472_000, 16757)
			// Standard Error: 391_587
			.saturating_add(Weight::from_parts(48_413_213, 0).saturating_mul(c.into()))
