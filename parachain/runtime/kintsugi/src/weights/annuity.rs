...
//! Autogenerated weights for escrow_annuity
//!
...
/// Weights for escrow_annuity using the Substrate node and recommended hardware.
...
impl<T: frame_system::Config> annuity::WeightInfo for WeightInfo<T> {
	...
	fn withdraw_rewards() -> Weight {
		...
		Weight::from_parts(39_336_000, 17504)
	...
	fn update_rewards() -> Weight {
		...
		Weight::from_parts(14_252_000, 2590)
