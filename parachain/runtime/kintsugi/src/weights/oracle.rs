...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(u: u32, ) -> Weight {
		...
		Weight::from_parts(84_108_000, 3494)
			// Standard Error: 27_861
			.saturating_add(Weight::from_parts(45_215_387, 0).saturating_mul(u.into()))
	...
	fn feed_values	(u: u32, ) -> Weight {
		...
		Weight::from_parts(41_032_000, 3770)
			// Standard Error: 18_556
			.saturating_add(Weight::from_parts(8_259_400, 0).saturating_mul(u.into()))
	...
	fn insert_authorized_oracle	() -> Weight {
		...
		Weight::from_parts(24_359_000, 0)
