...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(u: u32, ) -> Weight {
		...
		// Minimum execution time: 68_495_000 picoseconds.
		Weight::from_parts(69_297_000, 16631)
			// Standard Error: 52_592
			.saturating_add(Weight::from_parts(27_468_586, 0).saturating_mul(u.into()))
	...
	fn feed_values(u: u32, ) -> Weight {
		...
		Weight::from_parts(32_853_000, 6833)
			// Standard Error: 7_510
			.saturating_add(Weight::from_parts(4_300_961, 0).saturating_mul(u.into()))
	...
	fn insert_authorized_oracle() -> Weight {
		...
		Weight::from_parts(34_046_000, 1021)
	...
	fn remove_authorized_oracle() -> Weight {
		...
		Weight::from_parts(22_164_000, 1021)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}