...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(_u: u32, ) -> Weight {
		...
		//  Estimated: `5150990`
		// Minimum execution time: 174_823_000 picoseconds.
		Weight::from_parts(95_104_167_000, 5150990)
	...
	fn feed_values	(_u: u32, ) -> Weight {
		...
		//  Measured:  `295`
		//  Estimated: `3770`
		// Minimum execution time: 115_776_000 picoseconds.
		Weight::from_parts(29_582_842_000, 3770)
	...
	fn remove_authorized_oracle	() -> Weight {
		...
		Weight::from_parts(64_119_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}