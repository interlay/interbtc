...
impl<T: frame_system::Config> clients_info::WeightInfo for WeightInfo<T> {
	...
	fn set_current_client_release	(n: u32, _u: u32, ) -> Weight {
		...
		Weight::from_parts(33_156_363, 0)
			// Standard Error: 2_280
			.saturating_add(Weight::from_parts(5_748, 0).saturating_mul(n.into()))
	...
	fn set_pending_client_release	(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(30_251_578, 0)
			// Standard Error: 1_658
			.saturating_add(Weight::from_parts(12_923, 0).saturating_mul(n.into()))
			// Standard Error: 1_658
			.saturating_add(Weight::from_parts(6_099, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}