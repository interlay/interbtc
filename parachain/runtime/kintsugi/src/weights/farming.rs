...
impl<T: frame_system::Config> farming::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(c: u32, ) -> Weight {
		...
		//  Measured:  `189 + c * (41 ±0)`
		//  Estimated: `6342 + c * (3717 ±45)`
		// Minimum execution time: 36_730_000 picoseconds.
		Weight::from_parts(24_682_700, 6342)
			// Standard Error: 165_655
			.saturating_add(Weight::from_parts(14_905_914, 0).saturating_mul(c.into()))
	...
	fn update_reward_schedule	() -> Weight {
		...
		Weight::from_parts(133_960_000, 13302)
	...
	fn remove_reward_schedule	() -> Weight {
		...
		//  Measured:  `582`
		//  Estimated: `9763`
		// Minimum execution time: 94_335_000 picoseconds.
		Weight::from_parts(101_456_000, 9763)
	...
	fn deposit	(c: u32, ) -> Weight {
		...
		Weight::from_parts(108_592_878, 16211)
			// Standard Error: 360_926
			.saturating_add(Weight::from_parts(18_648_671, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn withdraw	(c: u32, ) -> Weight {
		...
		Weight::from_parts(98_027_403, 16211)
			// Standard Error: 283_984
			.saturating_add(Weight::from_parts(18_696_973, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes(3_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(c.into())))
	...
	fn claim	() -> Weight {
		...
		Weight::from_parts(171_999_000, 23913)
