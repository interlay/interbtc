...
use frame_support::{
    ...
    traits::{
        ...
        EqualPrivilegeOnly, ExistenceRequirement, Imbalance, InstanceFilter, OnUnbalanced, tokens::{Provenance, Fortitude}, ReservableCurrency, WithdrawReasons, SignedImbalance,
    },
...
use orml_traits::{currency::MutationHooks, parameter_type_with_key, BalanceStatus};
...
impl frame_support::traits::Currency<AccountId> for NativeCurrencyWithEd {
	...
	fn ensure_can_withdraw(
        ...
        <NativeCurrency as frame_support::traits::Currency<AccountId>>::ensure_can_withdraw(who, _amount, reasons, new_balance)
    }
	fn transfer(
		source: &AccountId,
		dest: &AccountId,
        ...
        <NativeCurrency as frame_support::traits::Currency<AccountId>>::transfer(source, dest, value, existence_requirement)
    }
...
use pallet_contracts::chain_extension::{ChainExtension, Ext};
