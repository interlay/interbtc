...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base	() -> Weight {
		...
		Weight::from_parts(6_934_000, 1489)
	...
	fn service_agenda_base	(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_186_450, 26848)
			// Standard Error: 9_136
			.saturating_add(Weight::from_parts(1_377_364, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched	(s: u32, ) -> Weight {
		...
		Weight::from_parts(37_686_000, 3644)
			// Standard Error: 34
	...
	fn service_task_periodic	() -> Weight {
		...
		Weight::from_parts(11_614_000, 0)
	}
	...
	fn schedule	(s: u32, ) -> Weight {
		...
		Weight::from_parts(30_736_375, 26848)
			// Standard Error: 11_844
			.saturating_add(Weight::from_parts(1_337_867, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Scheduler Agenda (r:1 w:1)
	...
	fn cancel	(s: u32, ) -> Weight {
		...
		Weight::from_parts(30_844_696, 26848)
			// Standard Error: 9_337
			.saturating_add(Weight::from_parts(2_421_338, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn schedule_named	(s: u32, ) -> Weight {
		...
		Weight::from_parts(38_263_727, 26848)
			// Standard Error: 71_026
			.saturating_add(Weight::from_parts(1_549_490, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Scheduler Lookup (r:1 w:1)
	...
	fn cancel_named	(s: u32, ) -> Weight {
		...
		Weight::from_parts(30_584_994, 26848)
			// Standard Error: 75_507
			.saturating_add(Weight::from_parts(2_770_795, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}