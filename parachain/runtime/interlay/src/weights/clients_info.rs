...
impl<T: frame_system::Config> clients_info::WeightInfo for WeightInfo<T> {
	...
	fn set_current_client_release(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(22_759_949, 0)
			// Standard Error: 516
			.saturating_add(Weight::from_parts(3_173, 0).saturating_mul(n.into()))
			// Standard Error: 516
			.saturating_add(Weight::from_parts(304, 0).saturating_mul(u.into()))
	...
	fn set_pending_client_release(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(22_474_481, 0)
			// Standard Error: 545
			.saturating_add(Weight::from_parts(3_572, 0).saturating_mul(n.into()))
			// Standard Error: 545
			.saturating_add(Weight::from_parts(1_835, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}