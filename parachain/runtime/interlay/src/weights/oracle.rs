...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(u: u32, ) -> Weight {
		...
		// Minimum execution time: 84_449_000 picoseconds.
		Weight::from_parts(84_870_000, 3494)
			// Standard Error: 34_383
			.saturating_add(Weight::from_parts(45_277_320, 0).saturating_mul(u.into()))
	...
	fn feed_values	(u: u32, ) -> Weight {
		...
		Weight::from_parts(37_956_000, 3770)
			// Standard Error: 27_009
			.saturating_add(Weight::from_parts(8_190_277, 0).saturating_mul(u.into()))
