...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(u: u32, ) -> Weight {
		...
		Weight::from_parts(126_432_000, 11433)
			// Standard Error: 52_310
			.saturating_add(Weight::from_parts(50_637_249, 0).saturating_mul(u.into()))
	...
	fn feed_values	(u: u32, ) -> Weight {
		...
		Weight::from_parts(50_155_000, 5263)
			// Standard Error: 18_635
			.saturating_add(Weight::from_parts(9_962_469, 0).saturating_mul(u.into()))
	...
	fn remove_authorized_oracle	() -> Weight {
		...
		Weight::from_parts(28_076_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}