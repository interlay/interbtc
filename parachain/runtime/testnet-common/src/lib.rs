...
#[macro_export]
macro_rules! construct_testnet { ($mod_config:ident) => {
    ...
    use frame_support::{
        ...
        traits::{
            ConstU32, Contains, Currency as PalletCurrency, EnsureOneOf, EqualPrivilegeOnly, ExistenceRequirement,
    ...
    pub use primitives::{Balance, CurrencyId, CurrencyId::Token, TokenSymbol::*};
    ...
    pub const VERSION: RuntimeVersion = RuntimeVersion {
        ...
        spec_name: create_runtime_str!($mod_config::SPEC_NAME),
        impl_name: create_runtime_str!($mod_config::IMPL_NAME),
        authoring_version: 1,
        spec_version: 7, // 1.13.0
        impl_version: 1,
    ...
    pub mod token_distribution {
        ...
        pub const INITIAL_ALLOCATION: Balance = 10_000_000_u128 * $mod_config::UNITS;
    ...
    parameter_types! {
        pub const TransactionByteFee: Balance = $mod_config::MILLICENTS;
    ...
    parameter_types! {
        ...
        pub PreimageBaseDepositz: Balance = $mod_config::deposit(2, 64); // todo: rename
        pub PreimageByteDepositz: Balance = $mod_config::deposit(0, 1);
    }
    ...
    parameter_types! {
        ...
        pub MinimumDeposit: Balance = 5 * $mod_config::UNITS;
        pub const EnactmentPeriod: BlockNumber = DAYS;
        pub PreimageByteDeposit: Balance = 10 * $mod_config::MILLICENTS;
    ...
    parameter_types! {
        ...
        pub const GetDepositBase: Balance = $mod_config::deposit(1, 88);
        // Additional storage item size of 32 bytes.
        pub const GetDepositFactor: Balance = $mod_config::deposit(0, 32);
    ...
    parameter_types! {
        pub const GetNativeCurrencyId: CurrencyId = $mod_config::NATIVE_CURRENCY_ID;
        pub const GetRelayChainCurrencyId: CurrencyId = $mod_config::PARENT_CURRENCY_ID;
        pub const GetWrappedCurrencyId: CurrencyId = $mod_config::WRAPPED_CURRENCY_ID;
    }
    ...
    parameter_types! {
        ...
        pub const BasicDeposit: Balance = 1000 * $mod_config::CENTS;       // 258 bytes on-chain
        pub const FieldDeposit: Balance = 250 * $mod_config::CENTS;        // 66 bytes on-chain
        pub const SubAccountDeposit: Balance = 200 * $mod_config::CENTS;   // 53 bytes on-chain
    ...
    mod XcmConfiguration {
        $crate::testnet_xcm_config!($mod_config);
    }
    use XcmConfiguration::*;
}}
