...
impl<T: frame_system::Config> dex_swap_router::WeightInfo for WeightInfo<T> {
	...
	fn swap_exact_tokens_for_tokens_general(a: u32, ) -> Weight {
		...
		Weight::from_parts(19_205_178, 15601)
			// Standard Error: 478_509
			.saturating_add(Weight::from_parts(67_046_190, 0).saturating_mul(a.into()))
	...
	fn swap_exact_tokens_for_tokens_stable(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1339 + c * (887 ±0)`
		//  Estimated: `16757 + c * (9459 ±19)`
		// Minimum execution time: 117_518_000 picoseconds.
		Weight::from_parts(119_297_000, 16757)
			// Standard Error: 395_476
			.saturating_add(Weight::from_parts(51_655_606, 0).saturating_mul(c.into()))
