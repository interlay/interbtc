...
impl<T: frame_system::Config> btc_relay::WeightInfo for WeightInfo<T> {
	...
	fn initialize() -> Weight {
		...
		//  Measured:  `1449`
		//  Estimated: `4520`
		// Minimum execution time: 58_924_000 picoseconds.
		Weight::from_parts(59_413_000, 4520)
	...
	fn store_block_header() -> Weight {
		...
		Weight::from_parts(69_326_000, 11898)
	...
	fn store_block_header_new_fork_sorted(f: u32, ) -> Weight {
		...
		Weight::from_parts(72_463_339, 9870)
			// Standard Error: 39_167
			.saturating_add(Weight::from_parts(10_829_670, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(7_u64))
	...
	fn store_block_header_new_fork_unsorted(f: u32, ) -> Weight {
		...
		Weight::from_parts(75_446_679, 12911)
			// Standard Error: 49_925
			.saturating_add(Weight::from_parts(11_555_286, 0).saturating_mul(f.into()))
	...
	fn store_block_header_reorganize_chains(f: u32, ) -> Weight {
		...
		// Minimum execution time: 364_997_000 picoseconds.
		Weight::from_parts(336_899_744, 101752)
			// Standard Error: 198_729
			.saturating_add(Weight::from_parts(11_276_703, 0).saturating_mul(f.into()))
