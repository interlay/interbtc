...
impl<T: frame_system::Config> btc_relay::WeightInfo for WeightInfo<T> {
	...
	fn initialize() -> Weight {
		...
		//  Measured:  `1449`
		//  Estimated: `4520`
		// Minimum execution time: 58_566_000 picoseconds.
		Weight::from_parts(60_925_000, 4520)
	...
	fn store_block_header(r: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `2634 + r * (100 ±0)`
		//  Estimated: `35730 + r * (1769 ±29)`
		// Minimum execution time: 164_475_000 picoseconds.
		Weight::from_parts(235_504_542, 35730)
