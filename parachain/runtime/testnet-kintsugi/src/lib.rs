...
construct_runtime! {
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        // # Zenlink
        ZenlinkProtocol: zenlink_protocol::{Pallet, Call, Storage, Event<T>} = 100,
        ZenlinkStableAmm: zenlink_stable_amm::{Pallet, Call, Storage, Event<T>}  = 101,
        ZenlinkSwapRouter: zenlink_swap_router::{Pallet, Call, Event<T>} = 102,
    }
}
