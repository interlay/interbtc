...
impl<T: frame_system::Config> clients_info::WeightInfo for WeightInfo<T> {
	...
	fn set_current_client_release(n: u32, _u: u32, ) -> Weight {
		...
		Weight::from_parts(25_981_234, 0)
			// Standard Error: 2_043
			.saturating_add(Weight::from_parts(10_746, 0).saturating_mul(n.into()))
	...
	fn set_pending_client_release(n: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(22_151_291, 0)
			// Standard Error: 611
			.saturating_add(Weight::from_parts(4_084, 0).saturating_mul(n.into()))
			// Standard Error: 611
			.saturating_add(Weight::from_parts(1_223, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}