...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize	(u: u32, ) -> Weight {
		...
		//  Measured:  `701 + u * (127 ±0)`
		//  Estimated: `11433 + u * (10172 ±0)`
		// Minimum execution time: 133_738_000 picoseconds.
		Weight::from_parts(134_454_000, 11433)
			// Standard Error: 242_453
			.saturating_add(Weight::from_parts(52_484_106, 0).saturating_mul(u.into()))
	...
	fn feed_values	(u: u32, ) -> Weight {
		...
		//  Measured:  `295`
		//  Estimated: `5263`
		// Minimum execution time: 51_227_000 picoseconds.
		Weight::from_parts(25_307_010, 5263)
			// Standard Error: 122_636
			.saturating_add(Weight::from_parts(9_965_704, 0).saturating_mul(u.into()))
	...
	fn insert_authorized_oracle	() -> Weight {
		...
		Weight::from_parts(34_262_000, 0)
