...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(u: u32, ) -> Weight {
		...
		// Minimum execution time: 70_959_000 picoseconds.
		Weight::from_parts(73_191_000, 19799)
			// Standard Error: 60_982
			.saturating_add(Weight::from_parts(29_960_582, 0).saturating_mul(u.into()))
	...
	fn feed_values(u: u32, ) -> Weight {
		...
		//  Measured:  `1283`
		//  Estimated: `6827`
		// Minimum execution time: 46_485_000 picoseconds.
		Weight::from_parts(330_434, 6827)
			// Standard Error: 21_002
			.saturating_add(Weight::from_parts(4_276_223, 0).saturating_mul(u.into()))
	...
	fn insert_authorized_oracle() -> Weight {
		...
		Weight::from_parts(22_955_000, 1019)
	...
	fn remove_authorized_oracle() -> Weight {
		...
		Weight::from_parts(31_299_000, 1019)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}