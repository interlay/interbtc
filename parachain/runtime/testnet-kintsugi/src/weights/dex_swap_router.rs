...
impl<T: frame_system::Config> dex_swap_router::WeightInfo for WeightInfo<T> {
	...
	fn swap_exact_tokens_for_tokens_general(a: u32, ) -> Weight {
		...
		//  Measured:  `1307 + a * (685 ±0)`
		//  Estimated: `15601 + a * (9007 ±15)`
		// Minimum execution time: 111_689_000 picoseconds.
		Weight::from_parts(1_810_323, 15601)
			// Standard Error: 311_031
			.saturating_add(Weight::from_parts(66_655_895, 0).saturating_mul(a.into()))
	...
	fn swap_exact_tokens_for_tokens_stable(c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1345 + c * (883 ±0)`
		//  Estimated: `16757 + c * (9459 ±15)`
		// Minimum execution time: 114_573_000 picoseconds.
		Weight::from_parts(116_462_000, 16757)
			// Standard Error: 386_921
			.saturating_add(Weight::from_parts(48_123_318, 0).saturating_mul(c.into()))
