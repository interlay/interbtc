...
impl<T: frame_system::Config> farming::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(c: u32, ) -> Weight {
		...
		Weight::from_parts(17_826_937, 5476)
			// Standard Error: 28_325
			.saturating_add(Weight::from_parts(8_727_038, 0).saturating_mul(c.into()))
	...
	fn update_reward_schedule() -> Weight {
		...
		Weight::from_parts(97_747_000, 10332)
	...
	fn remove_reward_schedule() -> Weight {
		...
		Weight::from_parts(57_090_000, 7783)
	...
	fn deposit(c: u32, ) -> Weight {
		...
		// Minimum execution time: 59_325_000 picoseconds.
		Weight::from_parts(61_079_816, 19365)
			// Standard Error: 140_387
			.saturating_add(Weight::from_parts(6_891_668, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn withdraw(c: u32, ) -> Weight {
		...
		Weight::from_parts(56_901_524, 19365)
			// Standard Error: 401_664
			.saturating_add(Weight::from_parts(8_567_280, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(c.into())))
			.saturating_add(T::DbWeight::get().writes(3_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(c.into())))
	...
	fn claim() -> Weight {
		...
		//  Measured:  `2768`
		//  Estimated: `28755`
		// Minimum execution time: 79_215_000 picoseconds.
		Weight::from_parts(85_055_000, 28755)
